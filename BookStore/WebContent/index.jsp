				...
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<img src="morenew/firstmove.jpg" style="width:1822px;height:855px;">
							<div class="carousel-caption">
								<!-- 轮播图上的文字 -->
							</div>
						</div>
						<div class="item">
							<img src="morenew/firstmovetwo.jpg" style="width:1822px;height:855px;">
							<div class="carousel-caption">
								<!-- 轮播图上的文字 -->
							</div>
						</div>
						<div class="item">
							<img src="img/3.jpg" style="width:1822px;height:855px;">
							<div class="carousel-caption" >
								<!-- 轮播图上的文字 -->
							</div>
						</div>
