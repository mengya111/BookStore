...
function changeImg(obj){
	obj.src="/HeimaShop/checkImg?time="+new Date().getTime();
}
			...
			<div class="col-md-8"
				...
				<form id="myform" class="form-horizontal" action="${pageContext.request.contextPath }/register" method="post" style="margin-top: 5px;"> 
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="date" class="form-control" name="birthday" placeholder="请输入年月日xxxx-xx-xx">
						</div>
					</div>
					
					
					<div style="color: #f00;text-align: center"><%=request.getAttribute("registerInfo")==null?"":request.getAttribute("registerInfo")%></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<img onclick="changeImg(this)" src="/HeimaShop/checkImg" />
						</div>
